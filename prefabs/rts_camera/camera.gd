...
var edge_scroll_was_enabled_at_ready := false
...
#		add_child(_scrolling_timer)
	...
	edge_scroll_was_enabled_at_ready = edge_scroll_enabled
...
func _input(event: InputEvent) -> void:
	...
	option_disable_edge_scrolling_when_using_mouse and
	edge_scroll_was_enabled_at_ready):
